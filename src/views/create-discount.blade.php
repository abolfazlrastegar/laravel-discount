                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            @foreach($discount->historyDiscount as $history)
                                                                <tr>
                                                                    ...
                                                                    <td><a href="{{asset('') . config('discount.url.prefix') . '/' . config('discount.url.discounts-user') . '/' . $history->user->id}}" class="btn btn-primary"> همه کد تخفیف های استفاده کرده </a></td>
                                                                </tr>
                                                            @endforeach
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{asset('') . config('discount.url.prefix') . '/' . config('discount.url.users_discount') . '/' .$discount->id}}" class="btn btn-primary">نمایش همه کاربران</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @if($discount->approved)
                                            <button type="button" class="btn btn-warning" onclick="statusDiscount({{$discount->id}}, 0, '{{config('discount.url.prefix')}}')">غیر فعال</button>
                                        @else
                                            <button type="button" class="btn btn-success" onclick="statusDiscount({{$discount->id}}, 1, '{{config('discount.url.prefix')}}')">فعال</button>
                                        @endif
                                        <button type="button" class="btn btn-danger" onclick="removeDiscount({{$discount->id}}, '{{config('discount.url.prefix')}}')">حذف</button>
                                    </td>
                                </tr>
                                <div class="modal fade edit-{{$discount->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form autocomplete="off" id="edit-discount-{{$discount->id}}" method="POST" action="{{config('discount.url.prefix')}}/edit-discount?type=edit&discountId={{$discount->id}}">
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-6">
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form autocomplete="off" id="insert_discount" method="POST" action="{{config('discount.url.prefix')}}/create?type=insert">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-6">
                                    <label>کد تخفیف</label>
