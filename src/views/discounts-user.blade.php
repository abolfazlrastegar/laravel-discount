    ...
    <div class="container-fluid" style="direction: rtl">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-primary">لیست کد تخفیف های کاربر استفاده کرده</h4>
                    </div>
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            @foreach($discount_user as $item)
                                <tr>
                                    <th scope="row">{{$item->id}}</th>
                                    <td class="text-warning text-center">{{$item->user->name }} {{$item->user->family }}</td>
                                    <td class="text-primary text-center">{{$item->discount->code}}</td>
