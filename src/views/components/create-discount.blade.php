                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="text-center">درصد کد تخفیف</th>
                        ...
                        <tbody>
                            @foreach($discounts as $discount)
                                <tr>
                                    ...
                                    <td class="text-danger text-center">%{{$discount->percent}}</td>
                                            ...
                                            <form autocomplete="off" id="edit-discount-{{$discount->id}}" method="POST" action="{{config('discount.prefix')}}/edit-discount?type=edit&discountId={{$discount->id}}">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <label>درصد محاسبه<span class="text-danger">(%)</span></label>
                                                            <input type="text" name="percent" id="edit-percent" value="{{number_format((int)$discount->percent)}}" class="form-control" placeholder="درصد محاسبه" onkeyup="success(this)">
                                                        </div>
                                                        <div class="col-6">
                                                            <label>بیشتر از این مبلغ</label>
                ...
                <form autocomplete="off" id="insert_discount" method="POST" action="{{config('discount.prefix')}}/create?type=insert">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label>درصد محاسبه<span class="text-danger">(%)</span></label>
                                <input type="text" name="percent" id="percent" class="form-control" placeholder="درصد محاسبه" onkeyup="success(this)">
                            </div>
                            <div class="col-6">
                                <label>بیشتر از این مبلغ</label>
